...
function intiLevel() {
  level1 = new Level(
    ...
    [
      ...
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/3-5.png", -719),
    ...
    [
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", -719),
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/1.png", 0),
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", 719),
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/1.png", 719 * 2),
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", 719 * 3),
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/1.png", 719 * 4),
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", 719 * 5),
      new MovingBackgroundObject("assets/img/5_background/layers/3_third_layer/1.png", 719 * 6),
    ],
    [
      new Bottle(-40, 370),
      new Bottle(900, 370),
