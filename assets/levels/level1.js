...
function intiLevel() {
  level1 = new Level(
    ...
    [
      ...
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/1-1.png", 0),
      new Obstacle("assets/img/10_hints/signpost-right-2.png", 210, 276, 105, 130, 24, 28, 0, 28),

      new BackgroundObject("assets/img/5_background/layers/air.png", 719),
      new BackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", 719),
      new BackgroundObject("assets/img/5_background/layers/2_second_layer/2.png", 719),
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/2-1.png", 719),
      ...
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/1-1.png", 719 * 2),
      new BackgroundObject("assets/img/5_background/layers/air.png", 719 * 3),
      new BackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", 719 * 3),
      new BackgroundObject("assets/img/5_background/layers/2_second_layer/2.png", 719 * 3),
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/2-1.png", 719 * 3),
      ...
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/1-1.png", 719 * 4),
      ...
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/2-1.png", 719 * 5),
      ...
      new BackgroundObject("assets/img/5_background/layers/1_first_layer/1-1.png", 719 * 6),
    ],
    [
      new Bottle(-40, 370),
      new Bottle(900, 370),
